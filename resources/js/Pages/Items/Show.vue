            ...
            <div class="pt-6">
                    ...
                    <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                        <li v-for="breadcrumb in product.breadcrumbs" :key="breadcrumb.id">
                            <div class="flex items-center">
                                <a :href="breadcrumb.href" class="mr-2 text-sm font-medium text-gray-900 dark:text-gray-200">{{ breadcrumb.name }}</a>
                        ...
                        <li class="text-sm">
                            <a :href="product.href" aria-current="page" class="font-medium text-indigo-500 hover:text-indigo-600">{{ product.name }}</a>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
                    ...
                    <div class="mt-4 lg:row-span-3 lg:mt-0">
                        ...
                        <p class="text-3xl tracking-tight text-gray-900 dark:text-gray-200">{{ product.price }}</p>
